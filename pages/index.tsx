  ...
  return (
    <div className="w-full">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <h1 className="mt-12 md:mt-28 lg:mt-32 dark:text-blue-300 text-blue-500 text-4xl md:text-6xl leading-none font-extrabold max-w-[270px] md:max-w-md">
          Full Stack & App Developer
        </h1>
        <p className="text-lg md:text-xl leading-7 font-normal dark:text-white text-gray-500 max-w-xl mt-8">
          Hey! I'm <span className="dark:text-blue-300 text-blue-600">Jose Bravo</span>, a software developer from Spain 🇪🇸 with over{' '}
        ...
        <h1 className="mt-32  dark:text-blue-300 text-blue-500 block text-3xl text-center leading-8 font-extrabold tracking-tight sm:text-4xl">
          Experience
        </h1>
        <div className="mt-8 prose prose-blue prose-lg md:prose-xl text-gray-500 mx-auto">
          ...
          <p className="dark:text-white text-gray-500">
            ...
            <Link passHref href="https://upourside.com">
              <a rel="noopener" target="_blank" className="dark:text-blue-300 text-blue-600 underline">
                Ourside
              </a>
            </Link>{' '}
        ...
        <div className="mt-8 mb-32 mx-auto flex flex-row space-x-8 justify-center z-30">
          <Link passHref href="https://twitter.com/josebravodev">
            <a target="_blank" rel="noopener" className="text-gray-800 dark:text-gray-100" aria-label="Jose's Twitter">
          ...
          <Link passHref href="https://www.linkedin.com/in/josebravodev/">
            <a target="_blank" rel="noopener" className="text-gray-800 dark:text-gray-100" aria-label="Jose's LinkedIn">
          ...
          <Link passHref href="https://github.com/ja-bravo">
            <a target="_blank" rel="noopener" className="text-gray-800 dark:text-gray-100" aria-label="Jose's Github">
              <svg fill="currentColor" width="24" height="24" viewBox="0 0 24 24">
                <path
                  fillRule="evenodd"
